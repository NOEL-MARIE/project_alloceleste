...
function startOrderWithoutAccount() {
  ...
  alert('Commencer la commande sans compte')
}

function findOrder() {
  // Logique de recherche de commande
  alert('Retrouver une commande')
}
</script>
...
<template>
  ...
  >
    <div class="grid items-center w-full grid-cols-1 gap-12 mx-auto max-w-7xl md:grid-cols-2">
      <!-- Texte gauche -->
      <div class="max-w-xl mx-auto text-white md:mx-0">
        <h2
          class="mb-8 text-4xl font-bold leading-snug font-TCCCUnityHeadline md:text-6xl md:mb-9 md:leading-tight"
        >
          Pas besoin de<br />créer un compte !
        </h2>
        <p
          class="mb-10 text-base font-light leading-relaxed text-gray-300 md:mb-12 md:text-2xl md:leading-relaxed font-inter"
        >
          Pas envie de perdre du temps ? Commence ta commande en 1 clic, on prendra tes infos plus
          tard.
        </p>

        <div class="flex flex-col space-y-8 text-base font-inter md:text-xl">
          <router-link
            :to="{ path: '/configurator', query: { tab: 'Casiers complets' } }"
